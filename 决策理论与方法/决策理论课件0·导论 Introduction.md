---
title: "决策理论课件0·导论 Introduction"
course: "决策理论与方法"
description: "石婧老师双语课件导论：决策在人类活动中的普遍性与跨学科形态（经济学、公共管理、组织制度、管理学、工业工程），数字时代数据/AI/加密货币/NFT/平台等新议题，Herbert Simon《管理行为》的有限理性思想，决策的狭义与广义定义、决策过程六步骤与结构化决策问题要素。"
...
- 决策是一切人类活动的核心
- 决策理论没有一个统一的"外形"
  - Theories, not theory, in different disciplines
  - 在很多学科中，与"决策"活动有关的理论并不以"决策"二字命名
...
<!--col:M-->
- 2025 年 7 月 18 日，美国总统特朗普在白宫正式签署《指导与建立美国稳定币国家创新法案》（简称 GENIUS 法案）
...
<!--col:M-->
#### 中国 NFT 数字藏品第一案
原告经漫画家马某授权，享有"我不是胖虎"系列作品在全球范围内独占的著作权财产性权利及维权权利，其发现被告经营的"元宇宙"NFT 平台上有用户铸造并发行"胖虎打疫苗"NFT。
...
他们认为疫情加速了流媒体服务的流行，让这些平台赚得盆满钵满。与此同时，流媒体所仰赖的技术和商业模式，也加速改变着从业者与平台的关系。

"数据就是权力。""对于普通影视从业者和观众而言，他们无从知晓某部电影有多少人点击又有多少人看完，不知道是哪部电影为平台带来订阅数的上升。平台没有公开这些数据。"于是，平台的繁荣是可见的，而影视作品的成败失去凭据。因为信息不对称，创作者很难与平台讨价还价。
...
<!--col:M-->
- Midjourney 是一个由同名研究实验室开发的人工智能程序
- 可根据文本生成图像
- 于 2022 年 7 月 12 日进入公开测试阶段。
...
<!--col:M-->
#### 不同学科中决策问题的融合与交织
a blend of mathematics, statistics, economics, philosophy, management, psychology and computer science interdisciplinary
